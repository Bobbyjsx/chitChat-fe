...
const SignUp = () => {
  ...
  return (
<main className="items-center flex flex-col justify-center h-full min-h-screen w-full sm:px-0 px-5">
        ...
        >
          ...
          <div className="col-span-full">
            <div className="flex items-center">
              <input
                className="h-4 w-4 rounded-lg !border-0 text-purple-600 focus:ring-purple-600"
                id="termsCondition"
                type="checkbox"
              ...
              >
                Signing up means you are okay with our Terms of Service,
                Privacy Policy, and our default Notification Settings
              </label>
            </div>
            {errors?.termsCondition?.message && (
              <p className="mt-2 text-sm text-red-600" id={'termsCondition-error'}>
                {errors?.termsCondition?.message}
              </p>
            )}
          </div>
